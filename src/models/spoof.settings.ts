/**
 * Definition of settings for forgery. Allowed settings:
...
export class SpoofSettings {
  /**
   * The maximum value of any Date, inclusive
   * Default is 1/1/4000
   */
  ...
  /**
   * The minimum value of any number, inclusive
   * Default is 1
   */
  numberMin?: number = 1;
  /**
   * The maximum value of any number, inclusive
   * Default is 1000
   */
